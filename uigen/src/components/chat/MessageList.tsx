...
function getToolLabel(toolName: string, args: Record<string, unknown> | undefined, isDone: boolean): string {
  ...
  if (toolName === "str_replace_editor" && command && filename) {
    const labels: Record<string, [string, string]> = {
      ...
      view: ["Reading", "Read"],
      undo_edit: ["Undoing edit in", "Undid edit in"],
    };
    const [active, done] = labels[command] ?? [command, command];
    return `${isDone ? done : active} ${filename}`;
  }
